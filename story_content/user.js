...
isiFile += "Kelas: " + kelas + "\n";
isiFile += "Materi 1, Kegiatan 1 " + "\n";

isiFile += "Tanggal: " + tanggal + "\n\n";



isiFile += "1. Luas permukaan prisma segitiga\n";

isiFile += "Jawab:"+j1 + "\n\n";



isiFile += "2. Luas permukaan kubus:\n";

isiFile += "Jawab:"+j2 + "\n\n";



isiFile += "3. Luas permukaan balok\n";

isiFile += "Jawab:"+ j3 + "\n\n";



isiFile += "4. Rumus umum:\n";
...
downloadLink.download = "Jawaban Materi 1 Kegiatan 1_" + nama +kelas+ ".txt";
...
var j1 = player.GetVar("m1");

var j2 = player.GetVar("m2");

var j3 = player.GetVar("m3");

var j4 = player.GetVar("m4");
...
var isiFile = "Nama Siswa: " + nama + "\n";
isiFile += "Kelas: " + kelas + "\n";
isiFile += "Materi 2, Kegiatan 1 " + "\n";

isiFile += "Tanggal: " + tanggal + "\n\n";



isiFile += "1. Luas permukaan limas segitiga:\n";

isiFile += "Jawab:"+ j1 + "\n\n";



isiFile += "2. Luas permukaan limas segiempat:\n";

isiFile +="Jawab:"+ j2 + "\n\n";



isiFile += "3. Luas permukaan limas segilima:\n";
...
downloadLink.href = URL.createObjectURL(textFile);
downloadLink.download = "Jawaban Materi 2 Kegiatan 1_" + nama +kelas+ ".txt";
document.body.appendChild(downloadLink);
downloadLink.click();
document.body.removeChild(downloadLink);
}
